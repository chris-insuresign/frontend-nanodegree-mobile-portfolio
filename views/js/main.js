...
var resizePizzas = function(size) {
    ...
    function changePizzaSizes(size) {
        // Select the first .randomPizzaContainer and put it in randPizza
        var randPizza = document.querySelector(".randomPizzaContainer")
        // pass it to determinDx
        var dx = determineDx(randPizza, size);
        // grab the width
        var newwidth = (randPizza.offsetWidth + dx) + 'px';
...
//Changed 200 to 50 which still is enough pizzas!
